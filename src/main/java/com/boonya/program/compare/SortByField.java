 ...
 * 根据字段排序
 * 
 * @package com.boonya.program.compare.SortByField
 * @date 2016年12月23日 上午11:38:26
 * @author pengjunlin
 * @comment
 * @update
 */
public class SortByField {
	...
	/**
	 * sort a list containing JavaBean according specific key( field ). Mostly,
	 * sortByField take ~1.5 times as much as Traditional implementation when
	 * list.size() > 100K
	 * 
	 * @param list
	 *            : list to be sorted
	...
	public static <E> void sortByField(List<E> list, String fieldName,
		...
		try {
			...
			e1.printStackTrace();
			System.out
					.println("The List<E> doesn't contain fieldName. That is "
							+ String.format("%s has no Field %s.", eClazz,
									fieldName));
	 ...
	 * ascend.
	 * 
	 * Mostly, sortByField take ~1.5 times as much as Traditional implementation
	 * when list.size() > 100K
	 * 
	 * @param list
	 *            list to be sort
